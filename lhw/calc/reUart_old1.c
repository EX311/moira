			...
			if ( poll_events.revents & POLLIN)            // event 가 자료 수신?
			{
				...
				switch(buf[0])
				{
					...
					case 't':
							...
							if(buf[1]=='0')	
							{ 
								if( (buf[2]=='0'&& buf[3]=='0' && buf[4]=='0') || (buf[2]=='1' && buf[3]=='5' && (buf[4]=='5' || buf[4]=='6' || buf[4]=='7' || buf[4]=='8')) )
									break;
								t_flag=0;
				...
				if( t_flag==31 || b_flag==31 || l_flag==31 || r_flag==31 )
				{
					...
					//if(  (t_rxdata[0]==1 && t_rxdata[1]==5 && (t_rxdata[2]==5 || t_rxdata[2]==6 || t_rxdata[2]==7 || t_rxdata[2]==8)) || (b_rxdata[0]==1 && b_rxdata[1]==5 && (b_rxdata[2]==5 || b_rxdata[2]==6 || b_rxdata[2]==7 || b_rxdata[2]==8)) || (r_rxdata[0]==1 && r_rxdata[1]==5 && (r_rxdata[2]==5 || r_rxdata[2]==6 || r_rxdata[2]==7 || r_rxdata[2]==8)) || (l_rxdata[0]==1 && l_rxdata[1]==5 && (l_rxdata[2]==5 || l_rxdata[2]==6 || l_rxdata[2]==7 || l_rxdata[2]==8))  ) 
